...
class MStyle {
  ...
  static TextStyle statusValueStyle =  TextStyle(
      fontSize: 8.sp, fontWeight: FontWeight.w400, color:Colors.white);

  static TextStyle focusedValueStyle =  TextStyle(
      fontSize: 16.sp, fontWeight: FontWeight.w700, color:Colors.green);

  static TextStyle headerStyle =  TextStyle(
      fontSize: 10.sp, fontWeight: FontWeight.w400, color: Color(0xff6C727F));

  static TextStyle value1Style = TextStyle(
      fontSize: 11.sp, fontWeight: FontWeight.w400, color: Colors.black);

  static TextStyle fieldValue2Style =  TextStyle(
      fontSize: 12.sp, fontWeight: FontWeight.w600, color: Color(0xff121826));
